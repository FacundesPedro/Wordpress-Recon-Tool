...
**Current state:** 12 modules, 60 steps, 500 tests passing (37/60 steps covered, 62%).
...
**Coverage:** 37/60 steps tested (62%). 23 steps remain untested, concentrated in 6 modules.
