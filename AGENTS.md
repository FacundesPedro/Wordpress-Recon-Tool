...
**Current state:** 14 modules, 96 steps, 1722 tests collected (1718 passing; the 4 PDF failures are the weasyprint/pango env issue). Wordlists set up with SecLists (13,370 plugins / 3,646 themes) at `~/.config/recon-wp/wordlists/`.
