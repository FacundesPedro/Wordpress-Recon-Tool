...
class ToolVersionMixin:
    """Mixin for BaseToolStep to integrate version checking."""
    ...
    def check_version_compatibility(self) -> Optional[VersionCheckResult]:
        """Check version compatibility for this tool step."""
